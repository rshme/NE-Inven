<form action="{{ route('ruang.update', $data->id_ruang) }}" class="form-horizontal" method="POST" id="form-edit">
	...
	<div class="form-group">
		...
		<input type="text" name="nama_ruang" value="{{ $data->nama_ruang }}" class="form-control" id="nama_ruang" autocomplete="off">
	</div>
	...
	<div class="form-group">
		...
		<input type="text" name="kode_ruang" class="form-control" id="kode_ruang" placeholder="Kosongkan jika tidak ada perubahan" autocomplete="off">
	</div>
