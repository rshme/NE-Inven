<form action="{{ route('jenis.update', $data->id_jenis) }}" class="form-horizontal" method="POST" id="form-edit">
	...
	<div class="form-group">
		...
		<input type="text" name="nama_jenis" value="{{ $data->nama_jenis }}" class="form-control" id="nama_jenis">
	</div>
	...
	<div class="form-group">
		...
		<input type="text" name="kode_jenis" class="form-control" id="kode_jenis" placeholder="Kosongkan jika tidak ada perubahan">
	</div>
